...
namespace Chrono
{
    ...
    {
        /// <summary>
        /// The main entry point for the applica1tion.
        /// </summary>
        [STAThread]
        static void Main()
        {
            ...
            LoggerWindow loggerWindow = new LoggerWindow(timeLogger);

            Watch firstWatch = timeLogger.GetWatch("Beta Watch");
            loggerWindow.DisplayStopwatch();
